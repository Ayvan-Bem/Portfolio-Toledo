...
window.addEventListener('scroll', function () {
    ...
    const offset = scrollPosition * 0.5; // Adjust the multiplier for desired parallax effect

    splineViewer.style.transform = `translateY(${offset}px)`;
});
...
document.getElementById('redirectButton').addEventListener('click', function () {
    window.location.href = 'https://youtu.be/cS5xX7tHtgM'; // Replace with your desired URL
});
